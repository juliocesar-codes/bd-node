        ...
        if (String(contentType).toUpperCase() == 'APPLICATION/JSON') {
            ...
            if (!validarDados) {
                ...
                if (validarId.status_code == 200) {
                    ...
                    if (result) {
                        let deletarFilmeGeneroByIdFilme = await controllerFilmeGenero.deletarFilmeGeneroByIdFilme(id)
                        console.log(deletarFilmeGeneroByIdFilme)
                        if (deletarFilmeGeneroByIdFilme.status_code == 200) {
                            ...
                            return deletarFilmeGeneroByIdFilme
                        }
                    } else {
                        return MESSAGE.ERROR_INTERNAL_SERVER_MODEL //500
